    ...
    public class Actions
    {
        ...
        public void InitializeData()
        {
            customers.AddRange(new[] {
                new Customer { Id = nextId++, Name = "Анна Петрова", Phone = "+375336482312", Email = "anna@gmail.com", Address = "ул. Ленина, 15" },
                new Customer { Id = nextId++, Name = "Иван Сидоров", Phone = "+375336482231", Email = "ivan@gmail.com", Address = "ул. Скабин, 28" }
            });

            bouquets.AddRange(new[] {
                new Bouquet { Id = nextId++, Name = "Романтический", Description = "Букет из красных роз", Price = 350, FlowersComposition = "25 красных роз", Quantity = 10 },
                new Bouquet { Id = nextId++, Name = "Весенний", Description = "Яркий весенний букет", Price = 280, FlowersComposition = "Тюльпаны, нарциссы", Quantity = 8 },
                new Bouquet { Id = nextId++, Name = "Эксклюзивный", Description = "Авторский букет", Price = 550, FlowersComposition = "Орхидеи, лилии", Quantity = 5 }
            });

            florists.AddRange(new[] {
                new Florist { Id = nextId++, Name = "Дмитрий", Surname = "Иванов", Experience = 5, Specialty = "Свадебные букеты", IsAvailable = true },
                new Florist { Id = nextId++, Name = "Мария", Surname = "Рыжова", Experience = 3, Specialty = "Композиции", IsAvailable = true }
            });
        }
